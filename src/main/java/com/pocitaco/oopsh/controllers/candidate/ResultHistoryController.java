...
public class ResultHistoryController extends BaseController {
    ...
    @FXML
    private MFXTableView<Result> tblResultHistory;
    ...
    protected void loadInitialData() {
        if (currentUser != null) {
            ...
            tblResultHistory.setItems(FXCollections.observableArrayList(myResults));
        }
    }
    ...
    private void setupTable() {
        ...
        tblResultHistory.getTableColumns().addAll(
